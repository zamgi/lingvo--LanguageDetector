...
namespace lingvo.ld.modelbuilder
{
    ...
    internal static class Program
    {
        ...
        /// 
        /// </summary>
        private sealed class word_comparer : IComparer< string >, IEqualityComparer< string >
        {
            public static word_comparer Inst { get; } = new word_comparer();
            private word_comparer() { }
        ...
        private sealed class portioner_t
        {
            ...
            /// 
            /// </summary>
            private sealed class tuple_word_value_comparer : IComparer< tuple_t >
            {
                public static tuple_word_value_comparer Inst { get; } = new tuple_word_value_comparer();
                private tuple_word_value_comparer() { }

                public int Compare( tuple_t x, tuple_t y ) => string.CompareOrdinal( x.word.Value, y.word.Value );
            }
            /// <summary>
            /// 
            /// </summary>
            private sealed class tuple_word_count_comparer : IComparer< tuple_t >
            {
                public static tuple_word_count_comparer Inst { get; } = new tuple_word_count_comparer();
                private tuple_word_count_comparer() { }
            ...
            public portioner_t( build_params_t bp, FileInfo fi, TfIdf _tfidf )
            {
                ...
                switch ( _Bp.Ngrams )
                {
                    case NGramsEnum.ngram_4:
                        ...
                        _DocumentNgrams_4 = new Dictionary< string, int >( _Bp.MaxPortionSize, word_comparer.Inst );
                    goto case NGramsEnum.ngram_3;

                    case NGramsEnum.ngram_3:
                        _OutputFilenames.Add( NGramsEnum.ngram_3, new List< string >() );
                        _DocumentNgrams_3 = new Dictionary< string, int >( _Bp.MaxPortionSize, word_comparer.Inst );
                    goto case NGramsEnum.ngram_2;

                    case NGramsEnum.ngram_2:
                        _OutputFilenames.Add( NGramsEnum.ngram_2, new List< string >() );
                        _DocumentNgrams_2 = new Dictionary< string, int >( _Bp.MaxPortionSize, word_comparer.Inst );
                    break;
                }
            ...
            private static IEnumerable< word_t > GroupByMerging_1( List< string > fileNames )
            {
                ...
                {
                    current_tuples.Sort( tuple_word_value_comparer.Inst );
            ...
            private static IEnumerable< word_t > GroupByMerging_2( List< tuple_t > tuples )
            {
                ...
                */
                ...
                for ( ; current_tuples.Count != 0; )
                {
                    current_tuples.Sort( tuple_word_count_comparer.Inst );
