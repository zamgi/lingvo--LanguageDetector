...
{    
    ...
    using BucketRef   = ManyLanguageDetectorModel.BucketRef;

    /// <summary>
    /// 
    /// </summary>
    [DebuggerDisplay("Count = {Count}")]
    public sealed class DictionaryNative : IDictionary< IntPtr, BucketValue >, IDisposable
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        //========================== EXTENSION ==========================//
        private static void AddToHead( ref BucketValue bucketVal, ref LanguageConfigAdv.Pair_v2 pair )
        {
        ...
        /*public bool TryAddToEndOfChain( ref LanguageConfig.Pair_v2 pair )
        {
        ...
        unsafe internal void AddNewOrToEndOfChain( ref LanguageConfigAdv.Pair_v2 pair )
        {
