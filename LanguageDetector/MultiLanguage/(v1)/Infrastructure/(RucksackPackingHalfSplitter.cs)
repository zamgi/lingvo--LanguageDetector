...
namespace lingvo.ld.v1
{
    ...
    {
        public LanguageConfigAdv LanguageConfig { get; private set; }
        public long ModelFilenameLength { get; private set; }

        public static LanguageConfigExt[] From( IEnumerable< LanguageConfigAdv > languageConfigs )
        {
    ...
    {
        public LanguageConfigAdv[] LanguageConfigs { get; private set; }
        ...
        {
            var partition = new LanguageConfigPartition() { LanguageConfigs = new LanguageConfigAdv[ items.Count ] };
    ...
    internal static class RucksackPackingExtensions
    {
        ...
        public static LanguageConfigPartition[] SplitByPartitionCountOrLess( this IEnumerable< LanguageConfigAdv > languageConfigs, int partitionCount )
        {
        ...
        public static LanguageConfigPartition[] SplitByPartitionCountOrGreater( this IEnumerable< LanguageConfigAdv > languageConfigs, int partitionCount )
        {
